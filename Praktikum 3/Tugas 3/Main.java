...
Nama file	: Main.java
Deskripsi 	: Merupakan kelas utama yang berisi logika interaksi dengan pengguna. Pengguna dapat memilih menu, memasukkan jumlah pesanan, dan melakukan pemesanan. Ketika pengguna memasukkan input yang tidak valid atau pesanan melebihi stok, eksepsi akan ditangkap dan pesan kesalahan akan ditampilkan.
        ...
        try {
            ...
            if (pilihanMenu == 1) {
                ...
                if ((pilihanMenu < 1) | (pilihanMenu > 2)) {
                    throw new MenuTidakTersediaException("Menu ini tidak tersedia.");
                   }
            }
